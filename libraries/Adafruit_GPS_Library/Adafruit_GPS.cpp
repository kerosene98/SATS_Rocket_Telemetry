...
/*
	...
	6) 	GPS Quality Indicator
		0 - fix not available
		1 - Differential GPS fix
	7)	Number of satellites in view, 00 - 12
	8)	Horizontal Dilution of precision
	9) 	Antenna Altitude above/below mean-sea-level (geoid)
	A) 	Units of antenna altitude, meters
	B)	Geoidal seperation, the difference between the WGS-84 earth
		ellipsoid and mean-sea-level (goeid), "-" means mean-sea-level below ellipsoid
	C) 	Units of geoidal separation, meters
	D)	Age of differential GPS data, time in seconds since last SC104
		type 1 or 9 update, null field when DGPS is not used.
	E)	DIfferential reference station ID, 0000 -- 1023
